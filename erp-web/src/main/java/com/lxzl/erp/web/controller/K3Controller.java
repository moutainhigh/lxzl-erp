...
public class K3Controller extends BaseController {
    ...
    public Result queryReturnOrderByNo(@RequestBody K3OrderQueryParam param, BindingResult validResult) {
        ServiceResult<String, K3ReturnOrder> serviceResult = k3Service.queryReturnOrderByNo(param.getOrderNo());
        return resultGenerator.generate(serviceResult.getErrorCode(), serviceResult.getResult());
    }
