...
public class ProductTest extends ERPUnTransactionalTest {
    ...
    public void queryAllProduct() throws Exception {
        ...
        Result result = getJsonTestResult("/product/queryAllProduct", productQueryParam);
    }
    @Test
    public void queryProductById() throws Exception {
        Product product = new Product();
        product.setProductId(2000013);
        Result result = getJsonTestResult("/product/queryProductById", product);
    }
    @Test
    public void queryAllProductEquipment() throws Exception {
        Product product = new Product();
        product.setProductId(2000013);
        Result result = getJsonTestResult("/product/queryAllProductEquipment", product);
    }
    ...
    public void addProductCategoryPropertyValue() throws Exception {
        ...
        Result result = getJsonTestResult("/product/addProductCategoryPropertyValue", productCategoryPropertyValue);
    }
    ...
    public void testAddProduct() throws Exception {
        ...
        Result result = getJsonTestResult("/product/add", product);
    }
    ...
    public void testUpdateProduct() throws Exception {
        ...
        productPropertyList.add(productProperty);
        product.setProductPropertyList(productPropertyList);
        Result result = getJsonTestResult("/product/update", product);
    }
    ...
    public void updateProductJson() throws Exception {
        ...
        Result result = getJsonTestResult("/product/update", FastJsonUtil.toBean(productJson, Product.class));
    }
    ...
    public void testQueryProductEquipmentDetail() throws Exception {
        ...
        Result result = getJsonTestResult("/product/queryProductEquipmentDetail", productEquipmentQueryParam);
    }
}
