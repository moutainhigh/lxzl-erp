...
public class PurchaseOrderControllerTest extends ERPUnTransactionalTest {
    ...
    public void addPurchaseOrder() throws Exception {
        ...
        Result result = getJsonTestResult("/purchaseOrder/add",purchaseOrder);
    }
    ...
    public void updatePurchaseOrder() throws Exception {
        ...
        purchaseOrder.setPurchaseOrderProductList(purchaseOrderProductList);
        Result result = getJsonTestResult("/purchaseOrder/update",purchaseOrder);
    }
    @Test
    ...
    public void commit() throws Exception {
        ...
        Result result = getJsonTestResult("/purchaseOrder/commit",purchaseOrderCommitParam);
    }
    @Test
    public void delete() throws Exception {
        PurchaseOrder purchaseOrder = new PurchaseOrder();
//        purchaseOrder.setPurchaseNo("PO201711181416106215000051764");
        Result result = getJsonTestResult("/purchaseOrder/delete",purchaseOrder);
    }
    @Test
...
//        purchaseOrderQueryParam.setCommitStatus(CommonConstant.COMMON_CONSTANT_YES);
        Result result = getJsonTestResult("/purchaseOrder/page",purchaseOrderQueryParam);
    }
    @Test
    public void queryPurchaseOrderByNo() throws Exception {
        PurchaseOrder purchaseOrder = new PurchaseOrder();
        purchaseOrder.setPurchaseNo("PO201712012025099545000061068");
        Result result = getJsonTestResult("/purchaseOrder/queryPurchaseOrderByNo",purchaseOrder);
    }
    @Test
...
//        purchaseOrderDeliveryQueryParam.setPurchaseDeliveryOrderStatus(0);
        Result result = getJsonTestResult("/purchaseOrder/pagePurchaseDelivery",purchaseOrderDeliveryQueryParam);
    }
    ...
    public void queryPurchaseDeliveryOrderByNo() throws Exception {
        ...
        Result result = getJsonTestResult("/purchaseOrder/queryPurchaseDeliveryOrderByNo",purchaseDeliveryOrder);
    }
...
//
        ...
        Result result = getJsonTestResult("/purchaseOrder/updatePurchaseReceiveOrder",purchaseReceiveOrder);
     }
    ...
    public void commitPurchaseReceiveOrder() throws Exception {
        ...
        Result result = getJsonTestResult("/purchaseOrder/commitPurchaseReceiveOrder",purchaseReceiveOrder);
    }
...
//        purchaseReceiveOrderQueryParam.setConfirmEndTime(confirmEndTime.getTime());//确认签单结束时间
        Result result = getJsonTestResult("/purchaseOrder/pagePurchaseReceive",purchaseReceiveOrderQueryParam);
    }
    ...
    public void queryPurchaseReceiveOrderByNo() throws Exception {
        ...
        Result result = getJsonTestResult("/purchaseOrder/queryPurchaseReceiveOrderByNo",purchaseReceiveOrder);
    }
    @Test
    public void endPurchaseOrder() throws Exception {
        PurchaseOrder purchaseOrder = new PurchaseOrder();
        purchaseOrder.setPurchaseNo("C201711091550440665000051897");
        Result result = getJsonTestResult("/purchaseOrder/endPurchaseOrder",purchaseOrder);
    }
    @Test
    public void continuePurchaseOrder() throws Exception {
        PurchaseOrder purchaseOrder = new PurchaseOrder();
        purchaseOrder.setPurchaseNo("PO201711201619009825000051652");
        Result result = getJsonTestResult("/purchaseOrder/continuePurchaseOrder",purchaseOrder);
    }
    @Test
