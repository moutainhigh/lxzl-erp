    ...
    public static List<ProductCategoryDO> convertProductCategoryDOTree(List<ProductCategoryDO> productCategoryDOList) {
        ...
        if (productCategoryDOList != null) {
            for (ProductCategoryDO node1 : productCategoryDOList) {
                ...
                for (ProductCategoryDO t : productCategoryDOList) {
                    if (t.getParentCategoryId().equals(node1.getId())) {
                        if (node1.getChildren() == null) {
                            List<ProductCategoryDO> myChildren = new ArrayList<ProductCategoryDO>();
                            myChildren.add(t);
