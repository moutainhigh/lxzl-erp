...
public class AmountSupport {
    ...
    public BigDecimal calculateRentAmount(Date rentStartDate, Date returnEndDate, BigDecimal unitAmount) {
        ...
        BigDecimal surplusDaysAmount = BigDecimalUtil.add(BigDecimalUtil.div(BigDecimalUtil.mul(unitAmount, new BigDecimal(previousAllDays)), new BigDecimal(previousSurplusDays), BigDecimalUtil.SCALE), BigDecimalUtil.div(BigDecimalUtil.mul(unitAmount, new BigDecimal(nextAllDays)), new BigDecimal(nextSurplusDays), BigDecimalUtil.SCALE));
