package com.lxzl.erp.core.service.functionSwitch;
...
public interface SwitchService {
    ...
    */
    ServiceResult<String,String> add(Switch functionSwitch);
    /**
     * 修改功能开关
     * @Author : XiaoLuYu
     * @Date : Created in 2018/4/4 16:21
     ...
     * @Return : com.lxzl.erp.common.domain.ServiceResult<java.lang.String,java.lang.String>
     */
    ServiceResult<String,String> update(Switch functionSwitch);
    /**
     * 分页查询功能开关
     * @Author : XiaoLuYu
     * @Date : Created in 2018/4/4 16:21
     ...
     * @Return : com.lxzl.erp.common.domain.ServiceResult<java.lang.String,java.lang.String>
     */
    ServiceResult<String,String> delete(Switch functionSwitch);
}
