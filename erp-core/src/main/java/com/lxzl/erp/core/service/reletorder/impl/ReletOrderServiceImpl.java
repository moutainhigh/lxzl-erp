...
//                orderDO.setOrderStatus(OrderStatus.ORDER_STATUS_RELET);
    ...
    public ServiceResult<String, Boolean> handleReletSendMessage(Date currentTime) {
        ...
        cal.add(Calendar.DAY_OF_MONTH, 14);  //按天租 提前15天
        ...
        calLong.add(Calendar.DAY_OF_MONTH, 29);  //按月租  提前30天
...
//        }
    ...
    private String validReletTimeRange(Date returnTime, Date currentTime, Integer rentType) {
        ...
        if ((OrderRentType.RENT_TYPE_MONTH.equals(rentType) && dayCount < -29)
                || (OrderRentType.RENT_TYPE_DAY.equals(rentType) && dayCount < -14)) {  //订单： 按月租前30天 和  按天租前15天 可续租
