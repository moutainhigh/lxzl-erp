...
public class CustomerCompany implements Serializable {
	...
	@NotBlank(message = ErrorCode.CUSTOMER_NO_NOT_NULL,groups = {AddCustomerCompanyGroup.class,UpdateCustomerCompanyGroup.class})
	...
	@NotNull(message = ErrorCode.FOUND_TIME_NOT_NULL,groups = {AddCustomerCompanyGroup.class,UpdateCustomerCompanyGroup.class})
	private Date companyFoundTime;  //企业成立时间'
	private String industry;  //所属行业'
	private BigDecimal registeredCapital;  //注册资本'
	@NotNull(message = ErrorCode.OFFICE_NUMBER_NOT_NULL,groups = {AddCustomerCompanyGroup.class,UpdateCustomerCompanyGroup.class})
