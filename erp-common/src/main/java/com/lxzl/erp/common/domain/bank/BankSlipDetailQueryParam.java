...
public class BankSlipDetailQueryParam extends BasePageParam {
    ...
    @NotNull(message = ErrorCode.BANK_SLIP_DETAIL_LOAN_SIGN_IS_NULL,groups = {WorkbenchGroup.class})
    private Integer loanSign;   //借贷标志,1-贷（收入），2-借（支出）
    @NotNull(message = ErrorCode.BANK_SLIP_DETAIL_STATUS_IS_NULL,groups = {WorkbenchGroup.class})
