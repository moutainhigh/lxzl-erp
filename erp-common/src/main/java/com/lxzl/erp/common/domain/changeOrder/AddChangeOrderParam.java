...
public class AddChangeOrderParam {
    ...
    @NotBlank(message = ErrorCode.CUSTOMER_NO_NOT_NULL,groups = {AddChangeOrderParam.class})
    ...
    @Valid
    @NotNull(message = ErrorCode.ORDER_CUSTOMER_CONSIGN_NOT_NULL,groups = {AddChangeOrderParam.class})
