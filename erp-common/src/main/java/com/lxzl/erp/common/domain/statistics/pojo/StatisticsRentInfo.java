...
public class StatisticsRentInfo {
    ...
    public Page<StatisticsRentInfoDetail> getStatisticsRentInfoDetailPage() {
        return statisticsRentInfoDetailPage;
    }

    public void setStatisticsRentInfoDetailPage(Page<StatisticsRentInfoDetail> statisticsRentInfoDetailPage) {
        this.statisticsRentInfoDetailPage = statisticsRentInfoDetailPage;
    }
}
