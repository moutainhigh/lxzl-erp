...
public class HttpHeaderBuilder {
	...
	public static HttpHeaderBuilder custom() {
		return new HttpHeaderBuilder();
	}
	
	
	public HttpHeaderBuilder defaultConfig(){
	 ...
	 * @param acceptRanges
	 */
	public HttpHeaderBuilder acceptRanges(String acceptRanges) {
	 ...
	 * @return
	 */
	public HttpHeaderBuilder date(String date) {
	 ...
	 * @param expect
	 */
	public HttpHeaderBuilder expect(String expect) {
	 ...
	 * @return
	 */
	public HttpHeaderBuilder ifMatch(String ifMatch) {
	 ...
	 * @return
	 */
	public HttpHeaderBuilder ifModifiedSince(String ifModifiedSince) {
	 ...
	 * @return
	 */
	public HttpHeaderBuilder ifNoneMatch(String ifNoneMatch) {
	 ...
	 * @return
	 */
	public HttpHeaderBuilder ifRange(String ifRange) {
	 ...
	 * @return
	 */
	public HttpHeaderBuilder ifUnmodifiedSince(String ifUnmodifiedSince) {
	 ...
	 * @return
	 */
	public HttpHeaderBuilder maxForwards(String maxForwards) {
	 ...
	 */
	public HttpHeaderBuilder proxyAuthorization(String proxyAuthorization) {
	 ...
	 * @param range
	 */
	public HttpHeaderBuilder range(String range) {
	 ...
	 * @param te
	 */
	public HttpHeaderBuilder te(String te) {
	 ...
	 * @return
	 */
	public HttpHeaderBuilder warning(String warning) {
	 ...
	 * @return
	 */
	public HttpHeaderBuilder keepAlive(String keepAlive) {
