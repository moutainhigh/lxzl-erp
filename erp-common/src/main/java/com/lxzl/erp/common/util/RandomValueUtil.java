...
public class RandomValueUtil {
    ...
    private static String[] community_first = "万科,万达,中粮,壹方,皇庭,恒大,保利,绿地,正大,山水,和昌,天山,金地,金科,当代,鸿福,宏发,鸿坤,卓越,碧桂".split(",");
    private static String[] community_last = "城,家园,苑,公园,水郡,尚都,世纪,鑫苑,花园,园,公寓,天地,山峰".split(",");
    ...
    public static String getCommunityName() {
        int first_index = getNum(0, community_first.length - 1);
        String first = community_first[first_index];
        int second_index = getNum(0, community_last.length - 1);
        String second = community_last[second_index];
        return first + second;
    }
     ...
     * 返回手机号码
     */
    private static String[] telFirst = "134,135,136,137,138,139,150,151,152,157,158,159,130,131,132,155,156,133,153,186,170".split(",");
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 100; i++) {
            System.out.println(getNum(0,3) + getChineseName() + ":" + getTel() + ":" +getCommunityName());
        }
    }
}
