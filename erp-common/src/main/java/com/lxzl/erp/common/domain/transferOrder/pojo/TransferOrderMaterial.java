...
public class TransferOrderMaterial extends BasePO {
	...
	@NotBlank(message = ErrorCode.TRANSFER_ORDER_MATERIAL_NO_NOT_NULL,groups = {AddGroup.class,TramsferOrderMaterialOutGroup.class,DumpTransferOrderMaterialOutGroup.class})
