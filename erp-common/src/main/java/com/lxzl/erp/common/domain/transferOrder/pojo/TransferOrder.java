...
public class TransferOrder extends BasePO {
	...
	@NotNull(message = ErrorCode.TRANSFER_ORDER_MODE_NOT_NULL ,groups = {AddGroup.class,TransferOrderOutGroup.class,UpdateTransferOrderIntoGroup.class,UpdateTransferOrderOutGroup.class})
	private Integer transferOrderMode;   //转移方式，1转入，2转出（凭空转入转出）
	@NotNull(message = ErrorCode.TRANSFER_ORDER_TYPE_NOT_NULL ,groups = {AddGroup.class,TransferOrderOutGroup.class,UpdateTransferOrderIntoGroup.class,UpdateTransferOrderOutGroup.class})
	private Integer transferOrderType;   //转移类型，1外借入库转入，2试验机转入，3转出，99其他
	@NotNull(message = ErrorCode.WAREHOUSE_ID_NOT_NULL ,groups = {AddGroup.class,UpdateTransferOrderIntoGroup.class,UpdateTransferOrderOutGroup.class})
