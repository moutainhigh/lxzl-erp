...
public class CheckStatementOrder extends BasePO {
    ...
    private List<CheckStatementOrderDetail> statementOrderDetailList;

    private Integer owner;        //数据归属人，跟单员
    private String ownerName; //业务员姓名

    private String monthTime; //月时间
    ...
    public List<CheckStatementOrderDetail> getStatementOrderDetailList() {
        return statementOrderDetailList;
    }

    public void setStatementOrderDetailList(List<CheckStatementOrderDetail> statementOrderDetailList) {
