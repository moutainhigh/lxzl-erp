...
public class PeerDeploymentOrderStatus {
    ...
    public static final Integer PEER_DEPLOYMENT_ORDER_STATUS_PROCESSING_OUT = 24;   // 退回处理中
    public static final Integer PEER_DEPLOYMENT_ORDER_STATUS_CONFIRM_OUT = 28;   // 已退回
    public static final Integer PEER_DEPLOYMENT_ORDER_STATUS_CANCEL = 32;   // 取消
