...
public class TransferOrderProduct extends BasePO {
	...
	@NotNull(message = ErrorCode.TRANSFER_ORDER_PRODUCT_SKU_ID_NOT_NULL ,groups = {AddGroup.class,UpdateGroup.class})
	private Integer productSkuId;   //转移商品SKU ID
	@NotNull(message = ErrorCode.TRANSFER_ORDER_PRODUCT_COUNT_NOT_NULL ,groups = {AddGroup.class,UpdateGroup.class})
	private Integer productCount;   //商品数量
	@NotNull(message = ErrorCode.TRANSFER_ORDER_PRODUCT_IS_NEW_NOT_NULL ,groups = {AddGroup.class,UpdateGroup.class})
