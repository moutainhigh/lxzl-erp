package com.lxzl.erp.common.util.http;
...
public class HttpUtil {
    ...
    public static HttpClient getHttpClient() {
        ...
        if (true) {
           builder.setSSLSocketFactory(getDebugConnectionFactory());
        }
    ...
    private static SSLConnectionSocketFactory getDebugConnectionFactory() {
