...
CREATE TABLE `erp_order` (
  ...
  `total_credit_deposit_amount` decimal(10,2) NOT NULL DEFAULT 0 COMMENT '授信押金金额',
  `total_insurance_amount` decimal(10,2) NOT NULL DEFAULT 0 COMMENT '保险金额',
  ...
  `order_status` int(11) NOT NULL DEFAULT '0' COMMENT '订单状态，未付款,支付中,已付款,已发货,租赁中,退租,取消交易',
...
CREATE TABLE `erp_order_material` (
  ...
  `material_unit_amount` decimal(10,2) NOT NULL DEFAULT 0 COMMENT '物料单价',
  `material_amount` decimal(10,2) NOT NULL DEFAULT 0 COMMENT '物料价格',
  `deposit_amount` decimal(10,2) NOT NULL DEFAULT 0 COMMENT '押金金额',
  `credit_deposit_amount` decimal(10,2) NOT NULL DEFAULT 0 COMMENT '授信押金金额',
  `insurance_amount` decimal(10,2) NOT NULL DEFAULT 0 COMMENT '保险金额',
...
CREATE TABLE `erp_purchase_order_material` (
  ...
  `material_count` int(11) NOT NULL DEFAULT '1' COMMENT '物料总数',
  `material_amount` decimal(10,2) NOT NULL DEFAULT 0 COMMENT '物料单价',
  `data_status` int(11) NOT NULL DEFAULT '0' COMMENT '状态：0不可用；1可用；2删除',
  `remark` varchar(500) CHARACTER SET utf8 DEFAULT NULL COMMENT '备注',
  `create_time` datetime DEFAULT NULL COMMENT '添加时间',
  `create_user` varchar(20) NOT NULL DEFAULT '' COMMENT '添加人',
...
CREATE TABLE `erp_purchase_delivery_order_material` (
  ...
  `real_material_amount` decimal(10,2) NOT NULL DEFAULT 0 COMMENT '实际物料单价',
  `data_status` int(11) NOT NULL DEFAULT '0' COMMENT '状态：0不可用；1可用；2删除',
  `remark` varchar(500) CHARACTER SET utf8 DEFAULT NULL COMMENT '备注',
  `create_time` datetime DEFAULT NULL COMMENT '添加时间',
  `create_user` varchar(20) NOT NULL DEFAULT '' COMMENT '添加人',
