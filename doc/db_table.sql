...
CREATE TABLE `erp_customer_person` (
  ...
  `consign_address` varchar(200) COLLATE utf8_bin NOT NULL COMMENT '收货地址',
  `data_status` int(11) NOT NULL DEFAULT '0' COMMENT '状态：0不可用；1可用；2删除',
...
CREATE TABLE `erp_customer_company` (
  `id` int(20) NOT NULL AUTO_INCREMENT COMMENT '唯一标识',
  `customer_id` int(20) NOT NULL COMMENT '客户ID',
  `customer_no` varchar(20) COLLATE utf8_bin NOT NULL COMMENT '客户编码',
  `sales_man` varchar(24) COLLATE utf8_bin NOT NULL COMMENT '业务员',
  ...
  `customer_origin` int(20) NOT NULL COMMENT '客户来源,1地推活动，2展会了解，3业务联系，4百度推广，5朋友推荐，6其他广告',
  ...
  `registered_capital` decimal(15,2) NOT NULL COMMENT '注册资本',
  `company_found_time` datetime DEFAULT NULL COMMENT '企业成立时间',
  `industry` varchar(64) COLLATE utf8_bin NOT NULL COMMENT '所属行业',
  ...
  `legal_person_phone` varchar(24) COLLATE utf8_bin NOT NULL COMMENT '法人手机号',
  ...
  `connect_real_name` varchar(64) COLLATE utf8_bin NOT NULL COMMENT '紧急联系人',
  `connect_phone` varchar(24) COLLATE utf8_bin DEFAULT NULL COMMENT '紧急联系人手机号',
  `province` int(20) DEFAULT NULL COMMENT '省份ID，省份ID',
  `city` int(20) DEFAULT NULL COMMENT '城市ID，对应城市ID',
  `district` int(20) DEFAULT NULL COMMENT '区ID，对应区ID',
  `address` varchar(200) COLLATE utf8_bin DEFAULT NULL COMMENT '详细地址',
  `consign_address` varchar(200) COLLATE utf8_bin DEFAULT NULL COMMENT '收货地址',
  ...
  `list_first_need_products` text COLLATE utf8_bin COMMENT '首次所需设备   ',
  `list_later_need_products` text COLLATE utf8_bin COMMENT '后期所需设备',
  `remark` varchar(500) CHARACTER SET utf8 DEFAULT NULL COMMENT '备注',
  `data_status` int(11) NOT NULL DEFAULT '0' COMMENT '状态：0不可用；1可用；2删除',
  `create_time` datetime DEFAULT NULL COMMENT '添加时间',
  `create_user` varchar(20) COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '添加人',
  ...
  `update_user` varchar(20) COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=400025 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='公司客户表'
...
CREATE TABLE `erp_order` (
  ...
  `total_material_deposit_amount` decimal(15,2) NOT NULL DEFAULT 0 COMMENT '物料应该支付的押金金额',
  `total_material_credit_deposit_amount` decimal(15,2) NOT NULL DEFAULT 0 COMMENT '物料授信押金金额',
  `total_material_rent_deposit_amount` decimal(15,2) NOT NULL DEFAULT 0 COMMENT '物料总租赁押金金额',
...
CREATE TABLE `erp_change_order_material` (
  ...
  `change_order_id` int(20) NOT NULL COMMENT '换货ID',
  `change_order_no` varchar(100) NOT NULL COMMENT '换货编号',
  `src_change_material_id` int(20) NOT NULL  COMMENT '原物料ID',
  `dest_change_material_id` int(20) NOT NULL  COMMENT '目标物料ID',
  ...
  `src_change_material_snapshot` text COMMENT '原物料快照',
  `dest_change_material_snapshot` text COMMENT '目标物料快照',
  `data_status` int(11) NOT NULL DEFAULT '0' COMMENT '状态：0不可用；1可用；2删除',
  `remark` varchar(500) CHARACTER SET utf8 DEFAULT NULL COMMENT '备注',
  `create_time` datetime DEFAULT NULL COMMENT '添加时间',
  `create_user` varchar(20) NOT NULL DEFAULT '' COMMENT '添加人',
...
CREATE TABLE `erp_statement_order` (
  ...
  `statement_paid_time` date DEFAULT NULL COMMENT '结算单支付时间',
...
CREATE TABLE `erp_statement_order_detail` (
  ...
  `statement_detail_paid_time` date DEFAULT NULL COMMENT '结算单支付时间',
...
CREATE TABLE `erp_joint_material` (
  ...
  `update_user` varchar(20) COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='组合商品物料项表';